...
class Settings(BaseSettings):
    ...
    SMTP_USER:        str  = "safarinigeria@gmail.com"                        # your email address
    SMTP_PASSWORD:    str  = "hspnyvghfymsjyzu"                        # app password
    SMTP_FROM_EMAIL:  str  = "safarinigeria@gmail.com"                        # sender address
